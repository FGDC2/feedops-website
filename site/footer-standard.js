(function () {
  ...
  function standardFooter() {
    return [
      ...
      "      </a>",
      '      <div class="footer-group footer-legal-column">',
      ...
      '        <a href="' + href("free-google-shopping-feed-audit/") + '">Free Shopping Feed Audit</a>',
      "      </div>",
      "    </div>",
      ...
      "      </div>",
      "    </div>",
      '    <div class="footer-section-divider" aria-hidden="true"></div>',
      '    <div class="footer-brand-guides">',
      '      <div class="footer-heading">Guides</div>',
      '      <div class="footer-column">',
      '        <a href="' + href("guide/google-shopping-feed-optimization-guide/") + '">Google Shopping Feed Optimisation</a>',
      ...
      '        <a href="' + href("google-shopping-product-title-optimization/") + '">Google Shopping Title Optimisation</a>',
      "      </div>",
      "    </div>",
